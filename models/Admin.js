...
Admin.prototype.clean = function() {
  if(typeof(this.auth.username) != "string") {this.auth.username = ""}
...
Admin.prototype.validate = function() {
  if(this.auth.username = "") {this.log.push('You must provide a username')}
  if(this.auth.password = "") {this.log.push('You must provide a password')}
}
